-- college-humanized-content-batch-021-200-pending
-- Generated 2026-08-10.
-- Scope: expand the next 200 colleges that have not yet received an
...
SET
  ...
  data_source_urls = coalesce(c.data_source_urls, '[]'::jsonb) || jsonb_build_array(jsonb_build_object(
    'batch', 'college-humanized-content-batch-021-200-pending',
  ...
  data_clean_audit_note = 'college-humanized-content-batch-021-200-pending; expanded student-facing modules; no official course or fee invention; row remains queued for official-source refresh.',
  ...
  editorial_audit_note = 'Batch 021 expanded overview, admissions, eligibility, courses, fees, placements, facilities, hostel, scholarships, rankings, cutoff and student decision modules. Official source and human editor review still required before marking complete.',
