-- college-humanized-content-batch-025-1000-pending
...
SET
  ...
  data_source_urls = coalesce(c.data_source_urls, '[]'::jsonb) || jsonb_build_array(jsonb_build_object(
    'batch', 'college-humanized-content-batch-025-1000-pending',
  ...
  data_clean_audit_note = 'college-humanized-content-batch-025-1000-pending; expanded student-facing modules; no official course or fee invention; row remains queued for official-source refresh.',
  ...
  editorial_audit_note = 'Batch 025 expanded overview, admissions, eligibility, courses, fees, placements, facilities, hostel, scholarships, rankings, cutoff and student decision modules. Official source and human editor review still required before marking complete.',
...
-- Official-source course and fee overrides reviewed during batch 025.
-- These rows intentionally avoid guessing. Course rows are written only where an
-- official programme or admission page was reviewed. Fee values are written only
-- where an official fee page exposed programme-level amounts.

UPDATE public.colleges
SET
  official_website = 'https://cep.ac.in/',
  official_source_url = 'https://cep.ac.in/admission',
  fees = '',
  course_fee_content = '<h3>Official Courses And Fees</h3><p>College of Engineering Perumon course information was reviewed from the official admission and department pages. The verified public course list for this pass includes B.Tech Computer Science and Engineering, B.Tech Mechanical Engineering, B.Tech Electronics and Communication Engineering, B.Tech Electrical and Electronics Engineering, B.Tech Electronics and Computer Engineering, B.Tech Artificial Intelligence and Data Science, Part-Time B.Tech Electrical and Electronics Engineering and M.Tech. Fees are kept blank because no programme-wise official fee amount was safely mapped in this pass. Students should confirm the latest fee notice, category, quota, hostel charges and one-time payments on the official admission page before payment.</p><p>Source reviewed: <a href="https://cep.ac.in/admission" rel="nofollow noopener noreferrer">official admission page</a>.</p>',
  courses_count = 8,
  official_courses_verified = true,
  official_fees_verified = false,
  data_clean_method = 'source_review_humanized',
  data_clean_state = 'humanized_source_backed_course_verified_fee_pending',
  data_source_urls = coalesce(data_source_urls, '[]'::jsonb) || jsonb_build_array(jsonb_build_object(
    'batch', 'college-humanized-content-batch-025-1000-official-aware',
    'researched_at', '2026-08-10',
    'source_status', 'official_admission_course_page_reviewed',
    'official_source_url', 'https://cep.ac.in/admission',
    'course_policy', 'official courses updated, fees blank until official amount mapping'
  )),
  data_clean_audit_note = 'college-humanized-content-batch-025; official admission/course page reviewed; course rows updated; fees kept blank pending official amount mapping.',
  data_quality_score = greatest(coalesce(data_quality_score, 0), 86),
  updated_at = now()
WHERE slug = 'college-of-engineering-perumon-kollam';

DELETE FROM public.course_fees
WHERE college_slug = 'college-of-engineering-perumon-kollam';

INSERT INTO public.course_fees (college_slug, course_slug, course_name, fee_amount, fee_type, year)
VALUES
  ('college-of-engineering-perumon-kollam', 'b-tech-computer-science-and-engineering', 'B.Tech Computer Science and Engineering', NULL, NULL, '2026'),
  ('college-of-engineering-perumon-kollam', 'b-tech-mechanical-engineering', 'B.Tech Mechanical Engineering', NULL, NULL, '2026'),
  ('college-of-engineering-perumon-kollam', 'b-tech-electronics-and-communication-engineering', 'B.Tech Electronics and Communication Engineering', NULL, NULL, '2026'),
  ('college-of-engineering-perumon-kollam', 'b-tech-electrical-and-electronics-engineering', 'B.Tech Electrical and Electronics Engineering', NULL, NULL, '2026'),
  ('college-of-engineering-perumon-kollam', 'b-tech-electronics-and-computer-engineering', 'B.Tech Electronics and Computer Engineering', NULL, NULL, '2026'),
  ('college-of-engineering-perumon-kollam', 'b-tech-artificial-intelligence-and-data-science', 'B.Tech Artificial Intelligence and Data Science', NULL, NULL, '2026'),
  ('college-of-engineering-perumon-kollam', 'part-time-b-tech-electrical-and-electronics-engineering', 'Part-Time B.Tech Electrical and Electronics Engineering', NULL, NULL, '2026'),
  ('college-of-engineering-perumon-kollam', 'm-tech', 'M.Tech', NULL, NULL, '2026');

UPDATE public.colleges
SET
  official_website = 'http://www.cep.ac.in/',
  official_source_url = 'http://www.cep.ac.in/admission',
  fees = '',
  course_fee_content = '<h3>Official Courses And Fees</h3><p>College of Engineering Poonjar course information was reviewed from the official admission page. The verified public course list for this pass includes B.Tech Computer Science and Engineering, B.Tech Electronics and Communication Engineering, MCA, Diploma in Computer Engineering, Diploma in Electronics and Communication Engineering, Diploma in Electrical and Electronics Engineering, Diploma in Automobile Engineering and Diploma in Civil Engineering with Public Health and Environment. Fees are kept blank because a programme-wise official fee amount was not safely mapped in this pass. Students should verify fee structure, quota, hostel and one-time charges from the latest official notice before payment.</p><p>Source reviewed: <a href="http://www.cep.ac.in/admission" rel="nofollow noopener noreferrer">official admission page</a>.</p>',
  courses_count = 8,
  official_courses_verified = true,
  official_fees_verified = false,
  data_clean_method = 'source_review_humanized',
  ...
  data_quality_score = greatest(coalesce(data_quality_score, 0), 86),
  updated_at = now()
WHERE slug = 'college-of-engineering-poonjar-kottayam';

DELETE FROM public.course_fees
WHERE college_slug = 'college-of-engineering-poonjar-kottayam';

INSERT INTO public.course_fees (college_slug, course_slug, course_name, fee_amount, fee_type, year)
VALUES
  ('college-of-engineering-poonjar-kottayam', 'b-tech-computer-science-and-engineering', 'B.Tech Computer Science and Engineering', NULL, NULL, '2026'),
  ('college-of-engineering-poonjar-kottayam', 'b-tech-electronics-and-communication-engineering', 'B.Tech Electronics and Communication Engineering', NULL, NULL, '2026'),
  ('college-of-engineering-poonjar-kottayam', 'mca', 'MCA', NULL, NULL, '2026'),
  ('college-of-engineering-poonjar-kottayam', 'diploma-in-computer-engineering', 'Diploma in Computer Engineering', NULL, NULL, '2026'),
  ('college-of-engineering-poonjar-kottayam', 'diploma-in-electronics-and-communication-engineering', 'Diploma in Electronics and Communication Engineering', NULL, NULL, '2026'),
  ('college-of-engineering-poonjar-kottayam', 'diploma-in-electrical-and-electronics-engineering', 'Diploma in Electrical and Electronics Engineering', NULL, NULL, '2026'),
  ('college-of-engineering-poonjar-kottayam', 'diploma-in-automobile-engineering', 'Diploma in Automobile Engineering', NULL, NULL, '2026'),
  ('college-of-engineering-poonjar-kottayam', 'diploma-in-civil-engineering-public-health-and-environment', 'Diploma in Civil Engineering - Public Health and Environment', NULL, NULL, '2026');

UPDATE public.colleges
SET
  official_website = 'https://www.cethalassery.ac.in/',
  official_source_url = 'https://www.cethalassery.ac.in/ug-courses/',
  fees = 'Official fee page reviewed: B.Tech merit first-year payable at college office Rs 82,975; M.Tech Rs 47,745; MBA semester totals Rs 77,210, Rs 52,000, Rs 67,500, Rs 50,000; MCA semester totals Rs 66,170, Rs 33,200, Rs 52,700, Rs 33,200. Verify current category, quota, hostel and one-time charges before payment.',
  course_fee_content = '<h3>Official Courses And Fees</h3><p>College of Engineering Thalassery course information was reviewed from the official UG courses page and official fee structure page. The verified public course list for this pass includes B.Tech Civil Engineering, B.Tech Computer Science and Engineering, B.Tech Information Technology, B.Tech Electronics and Communication Engineering, B.Tech Electronics and Computer Science, B.Tech Electrical and Electronics Engineering, B.Tech Mechanical Engineering, B.Tech for Working Professionals, M.Tech, MBA and MCA.</p><p>The official fee page lists B.Tech merit first-year payable at the college office as Rs 82,975, M.Tech as Rs 47,745, MBA semester totals as Rs 77,210, Rs 52,000, Rs 67,500 and Rs 50,000, and MCA semester totals as Rs 66,170, Rs 33,200, Rs 52,700 and Rs 33,200. Students should confirm category, quota, hostel, exam and one-time charges before payment.</p><p>Sources reviewed: <a href="https://www.cethalassery.ac.in/ug-courses/" rel="nofollow noopener noreferrer">official UG courses page</a> and <a href="https://www.cethalassery.ac.in/fee-structure/" rel="nofollow noopener noreferrer">official fee structure page</a>.</p>',
  courses_count = 11,
  official_courses_verified = true,
  official_fees_verified = true,
  data_clean_method = 'source_review_humanized',
  data_clean_state = 'humanized_source_backed_course_and_fee_verified',
  data_source_urls = coalesce(data_source_urls, '[]'::jsonb) || jsonb_build_array(jsonb_build_object(
    'batch', 'college-humanized-content-batch-025-1000-official-aware',
    'researched_at', '2026-08-10',
    'source_status', 'official_course_and_fee_pages_reviewed',
    'official_course_url', 'https://www.cethalassery.ac.in/ug-courses/',
    'official_fee_url', 'https://www.cethalassery.ac.in/fee-structure/',
    'course_policy', 'official courses updated',
    'fee_policy', 'official fee-page amounts captured with verification caveat'
  )),
  data_clean_audit_note = 'college-humanized-content-batch-025; official course and fee pages reviewed; course rows and official fee summary updated.',
  data_quality_score = greatest(coalesce(data_quality_score, 0), 90),
  updated_at = now()
WHERE slug = 'college-of-engineering-thalassery-kannur';

DELETE FROM public.course_fees
WHERE college_slug = 'college-of-engineering-thalassery-kannur';

INSERT INTO public.course_fees (college_slug, course_slug, course_name, fee_amount, fee_type, year)
VALUES
  ('college-of-engineering-thalassery-kannur', 'b-tech-civil-engineering', 'B.Tech Civil Engineering', 82975, 'B.Tech merit first-year payable at college office', '2026'),
  ('college-of-engineering-thalassery-kannur', 'b-tech-computer-science-and-engineering', 'B.Tech Computer Science and Engineering', 82975, 'B.Tech merit first-year payable at college office', '2026'),
  ('college-of-engineering-thalassery-kannur', 'b-tech-information-technology', 'B.Tech Information Technology', 82975, 'B.Tech merit first-year payable at college office', '2026'),
  ('college-of-engineering-thalassery-kannur', 'b-tech-electronics-and-communication-engineering', 'B.Tech Electronics and Communication Engineering', 82975, 'B.Tech merit first-year payable at college office', '2026'),
  ('college-of-engineering-thalassery-kannur', 'b-tech-electronics-and-computer-science', 'B.Tech Electronics and Computer Science', 82975, 'B.Tech merit first-year payable at college office', '2026'),
  ('college-of-engineering-thalassery-kannur', 'b-tech-electrical-and-electronics-engineering', 'B.Tech Electrical and Electronics Engineering', 82975, 'B.Tech merit first-year payable at college office', '2026'),
  ('college-of-engineering-thalassery-kannur', 'b-tech-mechanical-engineering', 'B.Tech Mechanical Engineering', 82975, 'B.Tech merit first-year payable at college office', '2026'),
  ('college-of-engineering-thalassery-kannur', 'b-tech-for-working-professionals', 'B.Tech for Working Professionals', NULL, 'Official page reviewed, fee amount to verify by current notice', '2026'),
  ('college-of-engineering-thalassery-kannur', 'm-tech', 'M.Tech', 47745, 'Official fee page amount payable at college office', '2026'),
  ('college-of-engineering-thalassery-kannur', 'mba', 'MBA', 77210, 'Official fee page semester 1 amount', '2026'),
  ('college-of-engineering-thalassery-kannur', 'mca', 'MCA', 66170, 'Official fee page semester 1 amount', '2026');
