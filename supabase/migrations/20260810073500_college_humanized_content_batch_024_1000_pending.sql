-- college-humanized-content-batch-024-1000-pending
...
SET
  ...
  data_source_urls = coalesce(c.data_source_urls, '[]'::jsonb) || jsonb_build_array(jsonb_build_object(
    'batch', 'college-humanized-content-batch-024-1000-pending',
  ...
  data_clean_audit_note = 'college-humanized-content-batch-024-1000-pending; expanded student-facing modules; no official course or fee invention; row remains queued for official-source refresh.',
  ...
  editorial_audit_note = 'Batch 024 expanded overview, admissions, eligibility, courses, fees, placements, facilities, hostel, scholarships, rankings, cutoff and student decision modules. Official source and human editor review still required before marking complete.',
