-- college-humanized-content-batch-026-1000-official-strict
...
SET
  ...
  data_source_urls = coalesce(c.data_source_urls, '[]'::jsonb) || jsonb_build_array(jsonb_build_object(
    'batch', 'college-humanized-content-batch-026-1000-official-strict',
  ...
  data_clean_audit_note = 'college-humanized-content-batch-026-1000-official-strict; expanded student-facing modules; no official course or fee invention; row remains queued for official-source refresh.',
  ...
  editorial_audit_note = 'Batch 026 expanded overview, admissions, eligibility, courses, fees, placements, facilities, hostel, scholarships, rankings, cutoff and student decision modules. Official source and human editor review still required before marking complete.',
...
-- Strict course/fee cleanup for this apply-time batch.
-- After the content pass, every unverified batch-026 college has its legacy
-- course and fee data cleared. Official rows below refill only colleges where
-- an official source was reviewed.

DELETE FROM public.course_fees cf
USING public.colleges c
WHERE cf.college_slug = c.slug
  AND c.data_clean_audit_note like 'college-humanized-content-batch-026-1000-official-strict%';
...
SET
  ...
  courses_count = 0,
  fees = '',
  course_fee_content = '<h3>Courses And Fees</h3><p>No official course and fee source has been mapped for this DekhoCampus profile yet. To avoid wrong information, the course and fee table is kept blank until the official college website, prospectus, admission brochure, regulator approval list or fee notice is reviewed.</p><p>Please check the official college website or admission office for current courses, eligibility, intake and fee amounts before applying.</p>',
  official_courses_verified = false,
  official_fees_verified = false,
  data_clean_state = 'humanized_source_backed_courses_fees_blank_pending_official',
  data_clean_audit_note = data_clean_audit_note || ' Course and fee data cleared because no official source was mapped in this pass.',
  updated_at = now()
WHERE data_clean_audit_note like 'college-humanized-content-batch-026-1000-official-strict%'
  AND coalesce(official_courses_verified, false) = false;

UPDATE public.colleges
SET
  official_website = 'https://lawfaculty.du.ac.in/',
  official_source_url = 'https://lawfaculty.du.ac.in/',
  fees = '',
  course_fee_content = '<h3>Official Courses And Fees</h3><p>Faculty of Law, University of Delhi course information was reviewed from the official faculty website. The verified public course list for this pass includes LL.B, B.A. LL.B. (Hons.), B.B.A. LL.B. (Hons.), LL.M and Ph.D in Law. Fees are kept blank because no current programme-wise official fee amount was safely mapped in this pass.</p><p>Source reviewed: <a href="https://lawfaculty.du.ac.in/" rel="nofollow noopener noreferrer">official Faculty of Law website</a>.</p>',
  courses_count = 5,
  ...
  data_source_urls = coalesce(data_source_urls, '[]'::jsonb) || jsonb_build_array(jsonb_build_object(
    'batch', 'college-humanized-content-batch-026-1000-official-strict',
    'researched_at', '2026-08-10',
    'source_status', 'official_faculty_course_page_reviewed',
    'official_source_url', 'https://lawfaculty.du.ac.in/'
  )),
  data_clean_audit_note = 'college-humanized-content-batch-026; official course page reviewed; course rows updated; fees kept blank pending official amount mapping.',
  data_quality_score = greatest(coalesce(data_quality_score, 0), 88),
  updated_at = now()
WHERE slug = 'faculty-of-law-university-of-delhi-new-delhi';

DELETE FROM public.course_fees WHERE college_slug = 'faculty-of-law-university-of-delhi-new-delhi';
INSERT INTO public.course_fees (college_slug, course_slug, course_name, fee_amount, fee_type, year)
VALUES
  ('faculty-of-law-university-of-delhi-new-delhi', 'llb', 'LL.B', NULL, NULL, '2026'),
  ('faculty-of-law-university-of-delhi-new-delhi', 'ba-llb-hons', 'B.A. LL.B. (Hons.)', NULL, NULL, '2026'),
  ('faculty-of-law-university-of-delhi-new-delhi', 'bba-llb-hons', 'B.B.A. LL.B. (Hons.)', NULL, NULL, '2026'),
  ('faculty-of-law-university-of-delhi-new-delhi', 'llm', 'LL.M', NULL, NULL, '2026'),
  ('faculty-of-law-university-of-delhi-new-delhi', 'phd-law', 'Ph.D in Law', NULL, NULL, '2026');

UPDATE public.colleges
SET
  official_website = 'https://www.jmi.ac.in/law',
  official_source_url = 'https://www.jmi.ac.in/ACADEMICS/Faculty-Of-Studies/Faculty-Of-Law/Programmes/Courses',
  fees = '',
  course_fee_content = '<h3>Official Courses And Fees</h3><p>Faculty of Law, Jamia Millia Islamia course information was reviewed from the official JMI Faculty of Law programme page. The verified public course list for this pass includes B.A. LL.B. (Hons.), LL.M., LL.M. Executive, Ph.D Law, PG Diploma in Labour Law and PG Diploma in Air Space Law. Fee amounts are kept blank because the official programme pages ask students to refer to the current prospectus.</p><p>Source reviewed: <a href="https://www.jmi.ac.in/ACADEMICS/Faculty-Of-Studies/Faculty-Of-Law/Programmes/Courses" rel="nofollow noopener noreferrer">official JMI Law programme page</a>.</p>',
  courses_count = 6,
  official_courses_verified = true,
  official_fees_verified = false,
  data_clean_method = 'source_review_humanized',
  ...
  data_source_urls = coalesce(data_source_urls, '[]'::jsonb) || jsonb_build_array(jsonb_build_object(
    'batch', 'college-humanized-content-batch-026-1000-official-strict',
    'researched_at', '2026-08-10',
    'source_status', 'official_university_course_page_reviewed',
    'official_source_url', 'https://www.jmi.ac.in/ACADEMICS/Faculty-Of-Studies/Faculty-Of-Law/Programmes/Courses'
  )),
  data_clean_audit_note = 'college-humanized-content-batch-026; official university programme page reviewed; course rows updated; fees kept blank because official page refers fee checks to prospectus.',
  data_quality_score = greatest(coalesce(data_quality_score, 0), 88),
  updated_at = now()
WHERE slug = 'faculty-of-law-jamia-millia-islamia-university-new-delhi';

DELETE FROM public.course_fees WHERE college_slug = 'faculty-of-law-jamia-millia-islamia-university-new-delhi';
INSERT INTO public.course_fees (college_slug, course_slug, course_name, fee_amount, fee_type, year)
VALUES
  ('faculty-of-law-jamia-millia-islamia-university-new-delhi', 'ba-llb-hons', 'B.A. LL.B. (Hons.)', NULL, NULL, '2026'),
  ('faculty-of-law-jamia-millia-islamia-university-new-delhi', 'llm', 'LL.M.', NULL, NULL, '2026'),
  ('faculty-of-law-jamia-millia-islamia-university-new-delhi', 'llm-executive', 'LL.M. Executive', NULL, NULL, '2026'),
  ('faculty-of-law-jamia-millia-islamia-university-new-delhi', 'phd-law', 'Ph.D Law', NULL, NULL, '2026'),
  ('faculty-of-law-jamia-millia-islamia-university-new-delhi', 'pg-diploma-in-labour-law', 'PG Diploma in Labour Law', NULL, NULL, '2026'),
  ('faculty-of-law-jamia-millia-islamia-university-new-delhi', 'pg-diploma-in-air-space-law', 'PG Diploma in Air Space Law', NULL, NULL, '2026');

UPDATE public.colleges
SET
  official_website = 'https://www.fisat.ac.in/',
  official_source_url = 'https://www.fisat.ac.in/',
  fees = '',
  course_fee_content = '<h3>Official Courses And Fees</h3><p>Federal Institute of Science and Technology course information was reviewed from the official institute website. The verified public course list for this pass includes B.Tech programmes, M.Tech, MBA and MCA. Fees are kept blank because a current programme-wise official fee notice was not safely mapped in this pass.</p><p>Source reviewed: <a href="https://www.fisat.ac.in/" rel="nofollow noopener noreferrer">official FISAT website</a>.</p>',
  courses_count = 4,
  official_courses_verified = true,
  official_fees_verified = false,
  data_clean_method = 'source_review_humanized',
  ...
  data_source_urls = coalesce(data_source_urls, '[]'::jsonb) || jsonb_build_array(jsonb_build_object(
    'batch', 'college-humanized-content-batch-026-1000-official-strict',
    'researched_at', '2026-08-10',
    'source_status', 'official_institute_course_page_reviewed',
    'official_source_url', 'https://www.fisat.ac.in/'
  )),
  data_clean_audit_note = 'college-humanized-content-batch-026; official institute course page reviewed; course rows updated; fees kept blank pending official amount mapping.',
  data_quality_score = greatest(coalesce(data_quality_score, 0), 86),
  updated_at = now()
WHERE slug = 'federal-institute-of-science-and-technology-fisat-ernakulam';

DELETE FROM public.course_fees WHERE college_slug = 'federal-institute-of-science-and-technology-fisat-ernakulam';
INSERT INTO public.course_fees (college_slug, course_slug, course_name, fee_amount, fee_type, year)
VALUES
  ('federal-institute-of-science-and-technology-fisat-ernakulam', 'b-tech', 'B.Tech', NULL, NULL, '2026'),
  ('federal-institute-of-science-and-technology-fisat-ernakulam', 'm-tech', 'M.Tech', NULL, NULL, '2026'),
  ('federal-institute-of-science-and-technology-fisat-ernakulam', 'mba', 'MBA', NULL, NULL, '2026'),
  ('federal-institute-of-science-and-technology-fisat-ernakulam', 'mca', 'MCA', NULL, NULL, '2026');

UPDATE public.colleges
SET
  official_website = 'https://www.fergusson.edu/',
  official_source_url = 'https://www.fergusson.edu/',
  fees = '',
  course_fee_content = '<h3>Official Courses And Fees</h3><p>Fergusson College course information was reviewed from the official college website. The verified public course list for this pass includes undergraduate, postgraduate and doctoral programmes across arts, science, vocational and research streams. Fees are kept blank because a current programme-wise official fee amount was not safely mapped in this pass.</p><p>Source reviewed: <a href="https://www.fergusson.edu/" rel="nofollow noopener noreferrer">official Fergusson College website</a>.</p>',
  courses_count = 6,
  official_courses_verified = true,
  official_fees_verified = false,
  data_clean_method = 'source_review_humanized',
  ...
  data_source_urls = coalesce(data_source_urls, '[]'::jsonb) || jsonb_build_array(jsonb_build_object(
    'batch', 'college-humanized-content-batch-026-1000-official-strict',
    'researched_at', '2026-08-10',
    'source_status', 'official_college_course_page_reviewed',
    'official_source_url', 'https://www.fergusson.edu/'
  )),
  data_clean_audit_note = 'college-humanized-content-batch-026; official college course page reviewed; course rows updated; fees kept blank pending official amount mapping.',
  data_quality_score = greatest(coalesce(data_quality_score, 0), 86),
  updated_at = now()
WHERE slug = 'fergusson-college-pune';

DELETE FROM public.course_fees WHERE college_slug = 'fergusson-college-pune';
INSERT INTO public.course_fees (college_slug, course_slug, course_name, fee_amount, fee_type, year)
VALUES
  ('fergusson-college-pune', 'ba', 'BA', NULL, NULL, '2026'),
  ('fergusson-college-pune', 'bsc', 'B.Sc', NULL, NULL, '2026'),
  ('fergusson-college-pune', 'bvoc', 'B.Voc', NULL, NULL, '2026'),
  ('fergusson-college-pune', 'ma', 'MA', NULL, NULL, '2026'),
  ('fergusson-college-pune', 'msc', 'M.Sc', NULL, NULL, '2026'),
  ('fergusson-college-pune', 'phd', 'Ph.D', NULL, NULL, '2026');

UPDATE public.colleges
SET
  official_website = 'https://fatimacollegemdu.org/',
  official_source_url = 'https://fatimacollegemdu.org/',
  fees = '',
  course_fee_content = '<h3>Official Courses And Fees</h3><p>Fatima College, Madurai course information was reviewed from the official college website. The verified public course list for this pass includes undergraduate, postgraduate, M.Phil and Ph.D programmes across arts, science, commerce, management and computer applications. Fees are kept blank because current programme-wise official fee amounts were not safely mapped in this pass.</p><p>Source reviewed: <a href="https://fatimacollegemdu.org/" rel="nofollow noopener noreferrer">official Fatima College website</a>.</p>',
  courses_count = 8,
  official_courses_verified = true,
  official_fees_verified = false,
  data_clean_method = 'source_review_humanized',
  ...
  data_quality_score = greatest(coalesce(data_quality_score, 0), 86),
  updated_at = now()
WHERE slug = 'fatima-college-madurai';

DELETE FROM public.course_fees WHERE college_slug = 'fatima-college-madurai';
INSERT INTO public.course_fees (college_slug, course_slug, course_name, fee_amount, fee_type, year)
VALUES
  ('fatima-college-madurai', 'ba', 'BA', NULL, NULL, '2026'),
  ('fatima-college-madurai', 'bsc', 'B.Sc', NULL, NULL, '2026'),
  ('fatima-college-madurai', 'bcom', 'B.Com', NULL, NULL, '2026'),
  ('fatima-college-madurai', 'bba', 'BBA', NULL, NULL, '2026'),
  ('fatima-college-madurai', 'bca', 'BCA', NULL, NULL, '2026'),
  ('fatima-college-madurai', 'ma', 'MA', NULL, NULL, '2026'),
  ('fatima-college-madurai', 'msc', 'M.Sc', NULL, NULL, '2026'),
  ('fatima-college-madurai', 'phd', 'Ph.D', NULL, NULL, '2026');
