-- college-humanized-content-batch-027-all-remaining-official-strict
-- Generated 2026-08-10. All remaining pending colleges.
...
SET
  ...
  data_source_urls = coalesce(c.data_source_urls, '[]'::jsonb) || jsonb_build_array(jsonb_build_object(
    'batch', 'college-humanized-content-batch-027-all-remaining-official-strict',
  ...
  data_clean_audit_note = 'college-humanized-content-batch-027-all-remaining-official-strict; expanded student-facing modules; no official course or fee invention; row remains queued for official-source refresh.',
  ...
  editorial_audit_note = 'Batch 027 expanded overview, admissions, eligibility, courses, fees, placements, facilities, hostel, scholarships, rankings, cutoff and student decision modules. Official source and human editor review still required before marking complete.',
...
-- After the content pass, every unverified batch-027 selected college has its legacy
...
WHERE cf.college_slug = c.slug
  AND c.data_clean_audit_note like 'college-humanized-content-batch-027-all-remaining-official-strict%';
...
SET
  ...
  updated_at = now()
WHERE data_clean_audit_note like 'college-humanized-content-batch-027-all-remaining-official-strict%'
