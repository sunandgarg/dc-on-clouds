    ...
    >
      ...
      <div className="container relative z-10 px-4 py-8 md:py-14 lg:py-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div>
            <h1
              className="max-w-5xl select-none text-[40px] font-black leading-[1.02] tracking-[-0.052em] text-foreground min-[360px]:text-[43px] min-[390px]:text-[47px] min-[412px]:text-[50px] sm:text-[56px] sm:leading-[0.96] md:text-[68px] lg:text-[86px]"
