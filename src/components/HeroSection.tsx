        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,1.25fr)_minmax(360px,0.75fr)] lg:gap-12">
            ...
            <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent/10 border border-accent/25">
              ...
              <span className="inline-flex items-center gap-1.5 text-sm font-semibold text-muted-foreground select-none flex-wrap" aria-label="Your AI education guide trusted by more than one lakh students">
                <span className="relative flex h-2 w-2">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-500 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
                </span>
                <span className="hidden min-[390px]:inline">Your AI education guide •</span>
                <span className="min-[390px]:hidden">AI education guide •</span>
                1L+ students guided
              </span>
          </div>
