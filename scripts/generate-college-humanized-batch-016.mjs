...
const input = process.argv[2] || "data/college-official-enrichment/live-next-50-batch-016.json";
const migration = process.argv[3] || "supabase/migrations/20260809234500_college_humanized_content_batch_016_50_official_aware.sql";
const report = process.argv[4] || "reports/college-humanized-content-batch-016.md";
const researchedAt = process.argv[5] || "2026-08-09";
const batch = "college-humanized-content-batch-016-50-official-aware";
...
const officialOverrides = {
  "bh-gardi-college-of-engineering-and-technology-rajkot": {
    sourceUrl: "https://www.gardividyapith.ac.in/engineering",
