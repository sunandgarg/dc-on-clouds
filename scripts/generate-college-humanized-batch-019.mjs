...
const input = process.argv[2] || "data/college-official-enrichment/live-next-100-batch-019.json";
const migration = process.argv[3] || "supabase/migrations/20260810023000_college_humanized_content_batch_019_100_official_aware.sql";
const report = process.argv[4] || "reports/college-humanized-content-batch-019.md";
const researchedAt = process.argv[5] || "2026-08-09";
const batch = "college-humanized-content-batch-019-100-official-aware";
...
const officialOverrides = {
  ...
  "bhatkhande-music-institute-lucknow": {
    sourceUrl: "https://bhatkhandemusic.edu.in/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "Diploma in Music",
  ...
  "bhavan039s-college-mumbai": {
    sourceUrl: "https://bhavans.ac.in/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "B.A.",
      "B.Com",
  ...
  "bhavan039s-vivekananda-college-of-science-humanities-and-commerce-secunderabad": {
    sourceUrl: "https://bhavansvc.ac.in/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "B.A.",
      "B.Com",
  ...
  "bheemanna-khandre-institute-of-technology-bkit-bhalki": {
    sourceUrl: "https://bkit.edu.in/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
  ...
  "bholabhai-patel-college-of-computer-studies-bpccs-gandhi-nagar": {
    sourceUrl: "https://www.spuvvn.edu/academics/colleges/b-p-college-of-computer-studies/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "BCA",
      "B.Sc. Information Technology",
  ...
  "bidhan-chandra-krishi-viswavidyalaya-bckv-mohanpur": {
    sourceUrl: "https://www.bckv.edu.in/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
  ...
  "bihar-agricultural-university-bau-sabour-bhagalpur": {
    sourceUrl: "https://www.bausabour.ac.in/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "B.Sc. (Hons.) Agriculture",
      "B.Sc. (Hons.) Horticulture",
  ...
  "bihar-college-of-pharmacy-patna": {
    sourceUrl: "https://biharcollegeofpharmacy.com/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "D.Pharm",
      "B.Pharm",
