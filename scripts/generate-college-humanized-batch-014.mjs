...
const input = process.argv[2] || "data/college-official-enrichment/live-next-100-batch-014.json";
const migration = process.argv[3] || "supabase/migrations/20260809211000_college_humanized_content_batch_014_100.sql";
const report = process.argv[4] || "reports/college-humanized-content-batch-014.md";
const researchedAt = process.argv[5] || "2026-08-09";
const batch = "college-humanized-content-batch-014-100";
