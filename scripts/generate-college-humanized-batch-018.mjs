...
const input = process.argv[2] || "data/college-official-enrichment/live-next-50-batch-018.json";
const migration = process.argv[3] || "supabase/migrations/20260810013000_college_humanized_content_batch_018_50_official_aware.sql";
const report = process.argv[4] || "reports/college-humanized-content-batch-018.md";
const researchedAt = process.argv[5] || "2026-08-09";
const batch = "college-humanized-content-batch-018-50-official-aware";

const rows = JSON.parse(await readFile(input, "utf8"));

const officialOverrides = {
  "bharati-college-bc-new-delhi": {
    sourceUrl: "https://www.bharaticollege.du.ac.in/",
  ...
  "bharati-vidyapeeth-university-college-of-engineering-bvucoe-pune": {
    sourceUrl: "https://bvucoepune.edu.in/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
  ...
  "bharati-vidyapeeth-university-institute-of-management-and-entrepreneurship-development-imed-pune": {
    sourceUrl: "https://imed.bharatividyapeeth.edu/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "BBA",
      "BCA",
  ...
  "bharati-vidyapeeth-new-law-college-nlc-pune": {
    sourceUrl: "https://nlc.bharatividyapeeth.edu/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "B.A. LL.B.",
      "B.B.A. LL.B.",
  ...
  "bharati-vidyapeeth-dental-college-and-hospital-bvdch-pune": {
    sourceUrl: "https://dchpune.bharatividyapeeth.edu/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "BDS",
  ...
  "bharati-vidyapeeth-college-of-engineering-bvcoe-navi-mumbai": {
    sourceUrl: "https://bvcoenm.edu.in/courses/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
  ...
  "bharati-vidyapeeth039s-college-of-engineering-bvcoe-new-delhi": {
    sourceUrl: "https://www.bvcoend.ac.in/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
