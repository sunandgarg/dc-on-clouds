...
const input = process.argv[2] || "data/college-official-enrichment/live-next-100-batch-020.json";
const migration = process.argv[3] || "supabase/migrations/20260810033000_college_humanized_content_batch_020_100_official_aware.sql";
const report = process.argv[4] || "reports/college-humanized-content-batch-020.md";
const researchedAt = process.argv[5] || "2026-08-09";
const batch = "college-humanized-content-batch-020-100-official-aware";
...
const officialOverrides = {
  ...
  "birla-institute-of-applied-science-nainital": {
    sourceUrl: "https://birlainstitute.co.in/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "B.Tech Computer Science and Engineering",
      "B.Tech Electronics and Communication Engineering",
  ...
  "birla-institute-of-management-technology-bimtech-greater-noida": {
    sourceUrl: "https://www.bimtech.ac.in/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "PGDM",
  ...
  "birla-institute-of-technology-and-science-bits-pilani": {
    sourceUrl: "https://www.bits-pilani.ac.in/pilani/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "B.E. Chemical Engineering",
      "B.E. Civil Engineering",
  ...
  "birla-institute-of-technology-and-science-bits-pilani-south-goa": {
    sourceUrl: "https://www.bits-pilani.ac.in/goa/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "B.E. Chemical Engineering",
      "B.E. Computer Science",
  ...
  "birla-vishvakarma-mahavidyalaya-engineering-college-bvm-vallabh-vidyanagar": {
    sourceUrl: "https://www.bvmengineering.ac.in/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "B.Tech Civil Engineering",
  ...
  "birsa-agricultural-university-bau-ranchi": {
    sourceUrl: "https://www.bauranchi.org/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
  ...
  "bishop-appasamy-college-of-arts-and-science-coimbatore": {
    sourceUrl: "https://www.csibacas.org/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "B.A. English",
      "B.Com",
  ...
  "bishop-heber-college-bhc-thiruchirapalli": {
    sourceUrl: "https://bhc.edu.in/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "B.A.",
      "B.Com",
  ...
  "blde-university-bijapur": {
    sourceUrl: "https://www.bldedu.ac.in/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "MBBS",
      "MD",
  ...
  "bldea039s-vp-drpghalakatti-college-of-engineering-amp-technology-bijapur": {
    sourceUrl: "https://bldeacet.ac.in/",
    sourceStatus: "official_course_page_reviewed_fee_table_not_found",
    courses: [
      "B.E. Civil Engineering",
