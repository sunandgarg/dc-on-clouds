...
const input = process.argv[2] || "data/college-official-enrichment/live-next-200-batch-015.json";
const migration = process.argv[3] || "supabase/migrations/20260809223000_college_humanized_content_batch_015_200.sql";
const report = process.argv[4] || "reports/college-humanized-content-batch-015.md";
const researchedAt = process.argv[5] || "2026-08-09";
const batch = "college-humanized-content-batch-015-200";
...
if (!Array.isArray(rows) || rows.length !== 200) {
  errors.push(`Expected 200 records, got ${Array.isArray(rows) ? rows.length : "invalid input"}`);
}
