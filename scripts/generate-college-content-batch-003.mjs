...
const input = "data/college-official-enrichment/live-next-50-batch-003.json";
const output = "supabase/migrations/20260801130000_college_official_content_batch_003.sql";
const researchedAt = "2026-08-01";
const batch = "college-official-content-batch-003";
